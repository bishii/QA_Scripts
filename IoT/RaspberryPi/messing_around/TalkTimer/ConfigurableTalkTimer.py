...
GREEN_LED = 14
GREEN_LED_BLINK_RATES = (1,0.10)

YELLOW_LED = 15
YELLOW_LED_BLINK_RATES = (1,0.10)
...
while True:
	...
	LED_Blink(GREEN_LED, (1,0.10))
	LED_Blink(GREEN_LED, (1,0.10))

	LED_Blink(YELLOW_LED, (2,0.10))
	LED_Blink(YELLOW_LED, (2,0.10), True, 20)
	
	LED_Blink(RED_LED_1, (1,0.10), True, 3, SoundOn) 
	LED_Blink(RED_LED_2, (1,0.10), True, 5, SoundOn)
	LED_Blink(RED_LED_3, (1,0.10), True, 10, SoundOn)

	GPIO.output(BUZZER_1, GPIO.HIGH)
	sleep(1)
	GPIO.output(BUZZER_1, GPIO.LOW)
